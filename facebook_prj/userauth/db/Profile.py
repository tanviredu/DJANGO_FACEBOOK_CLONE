...
class Profile(models.Model):
    pid          = ShortUUIDField(max_length=25, length=7, alphabet='abcdefghijklmnopqrstuvwxyz0123456789')
    ...
    ### this follower and following are redundant
    ### one field could do
    ### and in facebookl like app
    ### friends one to many is enough.
    ### for coding purpose we use many to any
